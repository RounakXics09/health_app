        ...
        <Box className='div-center d-flex-col position-relative' sx={{
            ...
            <Grid2 container >
                <Grid2 item size={{ xs: 12, sm: 12, md: 8, lg: 8, xl: 8 }}>
                    ...
                    <Grid2 className='new-hero-heading'>
                    ...
                    <Grid2 container sx={{ py: 3, width: '80%' }} rowSpacing={2} columnSpacing={2}>
                        <Grid2 item size={{ xs: 12, sm: 12, md: 3, lg: 3, xl: 3 }}>
                            <Grid2 className='hero-inner-card green-hero-card'>
            ...
            <Grid2 container sx={{ width: '100%', py: 4 }} columnSpacing={4} rowSpacing={2}>
                <Grid2 item size={{ xs: 12, sm: 12, md: 3, lg: 3, xl: 3 }}>
