    ...
    return (
        <Box className='div-center hero-section-container d-flex-col position-relative'>
            <Grid2 className='health-heading-text position-relative width-100'>
                <div className='display-sm-none' style={{ top: '-30px', left: '20px', position: 'absolute' }} >
                    <img src={Hero1} height={'45px'} width={'45px'} />
                </div>
                <span>Your Health, </span>
                <span className='health-heading-secondary-text'>Simplified</span>
                <div className='display-sm-none' style={{ bottom: '-50px', right: '10px', position: 'absolute' }} >
            ...
            <Grid2 className='div-center position-relative width-100 d-flex-col-sm'>
                <div className='display-sm-none' style={{ top: '-50px', left: '50px', position: 'absolute' }} >
                ...
                <div className='display-sm-none' style={{ bottom: '0px', right: '80px', position: 'absolute' }} >
