  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Grid2 container rowSpacing={4}>
        ...
        {/* old hero page */}
        <Grid2 item sx={{ px: { xs: 2, sm: 2, md: 4, lg: 8, xl: 8 },pt:8,position:'relative' }} size={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
        ...
        <Grid2 item sx={{ px: { xs: 2, sm: 2, md: 4, lg: 8, xl: 8 }, py: 2 }} size={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
          <PhotoSection />
        </Grid2>
        <Grid2 item sx={{ px: { xs: 2, sm: 2, md: 4, lg: 8, xl: 8 }, py: 2 }} size={{ xs: 12, sm: 12, md: 12, lg: 12, xl: 12 }}>
          <Sponsers />
